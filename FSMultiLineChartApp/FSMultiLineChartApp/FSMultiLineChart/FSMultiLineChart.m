...
#import "FSMultiLineChart.h"
#import <QuartzCore/QuartzCore.h>
#import "UIColor+FSPalette.h"

@interface FSMultiLineChart()
...
@implementation FSMultiLineChart
...
{
    _dataArray=[NSMutableArray arrayWithArray:chartData];
    _data = [_dataArray objectAtIndex:0];
...
//    _max=_maxY;
    ...
    {
        NSArray *row=_dataArray[i];
        _data=row;
        if(i<[_colorArray count])
            _color=_colorArray[i];
        else
